...
function AssetNodeInner({ data }) {
  ...
  return (
    <NodeShell title={name} color="asset" pathLit={data.pathLit} pathDim={data.pathDim} status={data.status} runStartedAt={data.runStartedAt} finishedAt={data.finishedAt}>
