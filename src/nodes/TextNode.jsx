...
function TextNodeInner({ data }) {
  ...
  return (
    <NodeShell title={t('node.text')} color="text" pathLit={data.pathLit} pathDim={data.pathDim} status={data.status} runStartedAt={data.runStartedAt} finishedAt={data.finishedAt}>
